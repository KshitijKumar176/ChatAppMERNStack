    ...
    <div className="flex flex-col w-5/12">
      <div className="w-full p-6 rounded-lg shadow-md bg-brown-500 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        <h1 className="text-2xl font-semibold text-center text-gray-300">
          Login <span className="text-amber-950">Chat App</span>
        </h1>

        <form onSubmit={handleSubmit}>
          <div>
            <label className="label p-2">
              <span className="='text-base label-text text-gray-800 font-medium ">
                Username
              </span>
            </label>
          ...
          <div>
            <label className="label p-2">
              <span className="='text-base label-text font-medium text-gray-800">
                Password
              </span>
            </label>
            <label className="input input-bordered flex items-center gap-2">
